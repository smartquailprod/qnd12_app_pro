...
python manage.py collectstatic --settings=qnd12_app_pro.settings.pro --noinput 
...
uwsgi --socket = 0.0.0.0:9000 --workers 9 --master --enable-threads --module qnd12_app_pro.wsgi  --ini uwsgi_prod.ini
